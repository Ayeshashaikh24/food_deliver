...
useEffect(()=>{
  ...
  <div className="carousel-inner" id='carousel'>
    ...
    <div className="carousel-item">
      <img src="https://source.unsplash.com/random/500×00?momos" className="d-block w-100" alt="..."/>
    </div>
    <div className="carousel-item">
      <img src="https://source.unsplash.com/random/500×700?sea" className="d-block w-100" alt="..."/>
    </div>
  </div>
